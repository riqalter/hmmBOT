...
exports.run = async (client, message, args) => {
  let embed = new Discord.MessageEmbed()
    ...
    .addField(`:alarm_clock: Uptime`, "" + (Math.round(client.uptime / (1000 * 60 * 60))) + " Hour(s), " + (Math.round(client.uptime / (1000 * 60)) % 60) + " minute(s) and " + (Math.round(client.uptime / 1000) % 60) + " second(s)" + "")
